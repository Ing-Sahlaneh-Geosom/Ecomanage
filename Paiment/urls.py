...
urlpatterns = [
    ...
    # ✅ partial form (GET)
    path("types-paiement/form/", views.TypePaiementFormPartialView.as_view(), name="type_paiement_form_create"),
    path("types-paiement/form/<int:pk>/", views.TypePaiementFormPartialView.as_view(), name="type_paiement_form_update"),

    # ✅ AJAX CRUD (POST)
    path("types-paiement/create/", views.TypePaiementCreateAjaxView.as_view(), name="type_paiement_create"),
    path("types-paiement/<int:pk>/update/", views.TypePaiementUpdateAjaxView.as_view(), name="type_paiement_update"),
    path("types-paiement/<int:pk>/delete/", views.TypePaiementDeleteAjaxView.as_view(), name="type_paiement_delete"),
